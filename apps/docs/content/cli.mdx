...
| `rolle integration sync <integration>` | Rediscover accounts, subscriptions, or projects |
...
| `rolle session add iam-user --name N --access-key-id ID [--secret-access-key K] [--region R] [--mfa-device M] [--profile P]` | Add an IAM user |
