...
The cask installs the app and the `rolle` command. `mise use -g packslip:nateships/rolle` installs the CLI alone. Windows and Linux builds and CLI archives are on the [releases page](https://github.com/nateships/rolle/releases). Docs: [getrolle.com](https://getrolle.com).
