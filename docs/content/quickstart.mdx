---
title: Quickstart
description: Connect a cloud and start a session in the desktop app or the CLI.
---
...
<Steps>
  ...
  <Step title="Import what your machine already has">
    Onboarding offers **Import from this machine**. It finds AWS Identity Center portals in the AWS CLI and Granted configs, Azure tenants from the az CLI, gcloud Application Default Credentials, and sessions from a Leapp workspace. The same import is available later under **Add → Import from this machine**.
  </Step>
