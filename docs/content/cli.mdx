...
| `rolle tag add <name> [--color C] [--icon I]` | Create a tag. Colors: gray, blue, green, orange, red, purple, pink, yellow. Icons: tag, folder, briefcase, shield, flask, rocket, star, building, cloud, wrench |
