...
<CardGroup cols={3}>
  <Card title="Install" href="/install" icon="download">
    Homebrew, DMG, Windows installer, and AppImage.
  </Card>
  ...
  <Card href="/aws/identity-center">
    ...
    Identity Center, role chaining, IAM users, console login, profiles, and regions.
  </Card>
...
| Short-lived credentials | OS keychain, service `rolle` | Keychain access control; entries expire and are removed |
