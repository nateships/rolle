...
The **Profiles in ~/.aws/credentials** card under **Settings → AWS** and the last onboarding step list every profile with static keys and remove the ones you pick. The CLI does the same with `rolle cleanup`.
