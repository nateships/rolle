...
- **Settings → AWS → Static keys** and the last onboarding step list every section with static keys and remove the ones you pick. The CLI does the same with `rolle cleanup`.
