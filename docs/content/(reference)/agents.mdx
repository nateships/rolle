...
| `3` | Sign-in needed | Stop. Ask a person to run `rolle integration login <alias>`, or `rolle start <session>` for a console login. Sign-in opens a browser and needs a person to approve |
