...
The sidebar filters the table: **All sessions**, **Active**, **Favorites**, **Hidden**, **Manual** (sessions without an integration), and one entry per integration. A dot next to an integration shows whether it is signed in; hover it for the label.
